...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-2clfcvc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-2clfcvc.containers.anotherwebservice.com/
...
```
git clone git@github.com:Niemand3333/container-2clfcvc.git
cd container-2clfcvc
```
...
```
docker attach container-2clfcvc
```
